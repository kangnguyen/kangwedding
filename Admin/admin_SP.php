				...
				<div class="container fix006">
					<div class="row ad2">
							...
							<div class="col-md-8" style="margin-top:10px">
								<h3>NỘI DUNG<span style="color:REd"> QUẢN LÝ SẢN PHẨM</span></h3>
								<div>
									<?php 
									...
									?>
									<form action="admin_Xuly_SP.php" method="POST" enctype="multipart/form-data" class="formsp">
										<p class="ad4"><span>Mã Sản Phẩm (<em style="color:red">*</em>)</span><input type="text" name="MaSP" maxlength="5" placeholder="Ví dụ: AO001, AO002" ></input></p>
										<p class="ad4"><span>Tên Sản Phẩm (<em style="color:red">*</em>)</span><input type="text" name="TenSP"></input></p>
										<p class="ad4"><span>Đơn Giá (<em style="color:red">*</em>)</span><input type="text" name="DonGia"></input></p>
										<p class="ad4"><span>Hình Ảnh (<em style="color:red">*</em>)</span><input style="border:none;display:inline" type="file" name="File" value="Chọn file"></input></p>
										<p class="ad4"><span>Mô Tả</span><input type="text" name="MoTa"></input></p>
